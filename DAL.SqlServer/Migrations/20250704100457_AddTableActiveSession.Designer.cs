...
namespace DAL.SqlServer.Migrations
{
    ...
    [Migration("20250704100457_AddTableActiveSession")]
    partial class AddTableActiveSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.SessionProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Table", b =>
                {
                    ...
                    b.HasIndex("ActiveSessionId")
                        .IsUnique()
                        .HasFilter("[ActiveSessionId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.SessionProduct", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TableSession", "TableSession")
            ...
            modelBuilder.Entity("Domain.Entities.Table", b =>
                {
                    b.HasOne("Domain.Entities.TableSession", "ActiveSession")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Table", "ActiveSessionId")
